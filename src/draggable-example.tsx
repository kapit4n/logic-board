    ...
    return (
      <div style={{ width: 200, height: 200 }}>
        <Draggable
          ...
          {...dragHandlers}
        >
          <img className="handle" style={{ width: 100, height: 100 }} src="https://i.ytimg.com/vi/XUyBGgbtFe4/maxresdefault.jpg" />
        </Draggable>
